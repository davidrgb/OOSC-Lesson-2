...
public class BaseballGameTest {
    ...
    public static void main(String[] args) {
        ...
        ballStikeCountCheck(1, 2, 3, 1, 6, 5, 0, 1);
        ballStikeCountCheck(2, 1, 3, 6, 1, 5, 0, 1);
        ballStikeCountCheck(1, 2, 3, 8, 6, 3, 0, 1);
        ballStikeCountCheck(1, 2, 3, 8, 1, 0, 1, 0);
        ballStikeCountCheck(1, 2, 3, 2, 0, 8, 1, 0);
        ballStikeCountCheck(1, 2, 3, 3, 1, 8, 2, 0);
        ballStikeCountCheck(1, 2, 3, 1, 2, 3, 0, 3);
    }

    private static boolean ballStikeCountCheck(int k0, int k1, int k2, int g0, int g1, int g2, int balls, int strikes) {
